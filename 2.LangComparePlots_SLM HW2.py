...
for lang in df["language"].unique():
    ...
    color = "gold" if lang == "julia" or lang == "c" else "lightgrey"
...
ax[0].set_xticklabels(labels=df_to_plot["problem"], rotation=45)
ax[1].set_xticklabels(labels=df_to_plot["problem"], rotation=45)
ax[0].set_yscale("log")
